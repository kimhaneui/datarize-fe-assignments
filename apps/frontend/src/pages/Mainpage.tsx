    ...
    <div className="container">
      ...
      <div className="section">
        ...
        <p className="text">
          ...
          가격대는 2만원 이하부터 10만원 이상까지 만원 단위로 구분됩니다. 날짜를 선택해서 특정 기간을 조회할 수 있습니다.
        </p>
      </div>
      ...
      <div className="section">
        ...
        <p className="text">
          한 달 동안 가장 많이 구매한 고객을 내림차순/오름차순으로 정렬할 수 있습니다. 기본 정렬은 고객 ID입니다.
          각 고객의 ID, 이름, 총 구매 횟수, 총 구매 금액을 표시하며, 고객 이름으로 검색할 수 있는 기능이 포함됩니다.
        </p>
      </div>
